...
const Foodblog = () => {
   ...
   return (
    <>
      ...
      return( 
      <Link to={`/Food`} key={item.id}> <div className='flex'><img className='flex1' src={item.image} alt='Not found' height={230} width={230}/><div className='re'>{item.Title}</div></div></Link>
      )
  })}
        </div>
